...
uint256 hashGenesisBlock("0x54a3e50d31e730ce568d3857b4258107bd8c31670341fa3295209e1c3cd4cfc7");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    int64 nSubsidy = 0 * COIN;
		...
		nSubsidy = 3500000 * COIN;
                        ...
                        nSubsidy = 120 * COIN;//
                else if (nHeight < 25064)
                        nSubsidy = 50 * COIN;//
                else if (nHeight < 33128)
                        nSubsidy = 20 * COIN;//
                else if (nHeight < 41192)
                        nSubsidy = 10 * COIN;//
				else if (nHeight < 57302)
                        nSubsidy = 2.5 * COIN;//
                        else if (nHeight > 57301)
			nSubsidy = 0.05 * COIN; //21024 XTN per year
                        	                        
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 0.21 * 24 * 60 * 60; // Traincoin: 5.4 hr (roughly under 250 blocks)
static const int64 nTargetSpacing = 1.25 * 60; // Traincoin: 1.5 minutes
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal TrainCoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x54a3e50d31e730ce568d3857b4258107bd8c31670341fa3295209e1c3cd4cfc7");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "02 Apr 2014";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1396456480; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 947689;

        if (fTestNet)
        {
            block.nTime    = 1396456480;
            block.nNonce   = 947689;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x76f4cd603268293ce70202608c5b23e5d9402ddd6d8d487b70d998d82f0a5760"));
